<?php
$pageTitle = 'Sports Activity - Milestone School';
$metaDescription = 'See Milestone School\'s sports activities and events, building teamwork, discipline, and fitness among our learners.';
...
?>
    ...
    <section class="text-center mb-16">
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto italic" data-aos="fade-up" data-aos-delay="200">
        Celebrating athleticism, teamwork, and sportsmanship through our vibrant sports programs
      </p>
    </section>
    ...
    <div class="flex flex-wrap justify-center gap-3 mb-12" data-aos="fade-up" data-aos-delay="300">
      ...
      <a href="sports" class="px-6 py-2 bg-gradient-to-r from-primary to-teal-500 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
        Sports
      </a>
      ...
      <a href="graduation" class="px-6 py-2 bg-white text-gray-700 font-semibold rounded-full shadow-soft hover:shadow-hard border border-gray-200 hover:border-primary transform hover:scale-105 transition-all duration-300">
        Graduation
      </a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-16">
      <a href="sports" class="group block overflow-hidden rounded-2xl shadow-soft hover:shadow-hard transform transition-all duration-500 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
    ...
    <section class="mt-16 text-center max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="900">
      <div class="bg-gradient-to-br from-primary/10 via-teal-50 to-accent/10 p-10 rounded-2xl border-l-4 border-primary">
        <blockquote class="italic text-xl md:text-2xl text-gray-700 font-medium">
          "Through sports, we build character, foster teamwork, and celebrate the joy of physical activity and healthy competition."
        </blockquote>
