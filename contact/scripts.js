...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function injectPortalLinks() {
    ...
    if (existingDesktopPortalLink) {
      existingDesktopPortalLink.href = PORTAL_URL;
      existingDesktopPortalLink.target = '_blank';
      existingDesktopPortalLink.rel = 'noopener noreferrer';
    ...
    if (existingMobilePortalLink) {
      existingMobilePortalLink.href = PORTAL_URL;
      existingMobilePortalLink.target = '_blank';
      existingMobilePortalLink.rel = 'noopener noreferrer';
